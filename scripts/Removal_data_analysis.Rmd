...
# Import data
```{r import_data}
path <- "C:/Users/rmartin/OneDrive - Environmental Protection Agency (EPA)/Documents/CSS_Data/Data/fish_removal_data.xlsx"
...
#save(fit3, file = "C:/Users/rmartin/OneDrive - Environmental Protection Agency (EPA)/Documents/CSS_Data/fit2.rda")
```

### Parameters summary
Tabular summary of parameters in the linear predictors.
```{r load_mod2, eval=TRUE, include=FALSE}
load("C:/Users/rmartin/OneDrive - Environmental Protection Agency (EPA)/Documents/CSS_Data/fit3.rda")
```
